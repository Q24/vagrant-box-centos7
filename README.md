# vagrant-box-centos7
## Description
This project contains everything needed to build the centos7 vagrant box. The box is build using Vagrant's packer tool. Currently only a box for the VirtualBox provider is built.

The box resulting is based on a clean CentOS 7 minimal install. We try to keep the builds up to date with the latest version of this box. Several tools are included in the box:
* ansible

Built boxes can be found on [Vagrant Cloud](https://app.vagrantup.com/ilionx/boxes/centos7)
